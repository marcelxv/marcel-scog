  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-center min-h-[500px] w-full max-w-4xl mx-auto py-10 px-4 gap-8">
      ...
      <div className="w-full md:w-1/2 bg-white dark:bg-neutral-950 rounded-3xl shadow-lg p-8 flex flex-col items-center border border-neutral-200 dark:border-neutral-800">
        <form className="w-full space-y-5" onSubmit={handleSubmit} aria-live="polite" aria-describedby="form-status">
          ...
          <div>
            <label htmlFor="name" className="block font-semibold text-neutral-800 dark:text-white mb-1">Name</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div>
            <label htmlFor="email" className="block font-semibold text-neutral-800 dark:text-white mb-1">Email</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <div>
            <label htmlFor="message" className="block font-semibold text-neutral-800 dark:text-white mb-1">Message</label>
            <textarea
              id="message"
              name="message"
              rows={5}
          ...
          {status === 'success' && (
            <p className="text-green-600 text-center mt-2" role="status">{successMsg}</p>
          )}
          {status === 'error' && (
            <p className="text-red-600 text-center mt-2" role="alert">{errorMsg}</p>
          )}
        </form>
      </div>
      {/* Mobile illustration */}

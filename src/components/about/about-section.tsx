...
const marcelExperiences: Experience[] = [
  {
    ...
    description: '- Integrated frontend with backend services (Node.js, Ruby on Rails, PostgreSQL) - Set up CI/CD pipelines with AWS, Docker, and Kubernetes - Improved Core Web Vitals scores by 60% through optimization techniques  ---',
  ...
  },
  {
    ...
    startDate: new Date(),
    // endDate is omitted for current position
    description: '- Facilitated agile ceremonies, technical planning, and architectural decisions - Mentored developers and improved team delivery speed significantly - Implemented performance optimizations resulting in 40% faster page load times',
  ...
  },
  {
    ...
    startDate: new Date(),
    // endDate is omitted for current position
    description: '- Partnered with product and design to iterate quickly on user flows, feedback loops, and internal dashboards - Built scalable data processing systems handling regulatory compliance workflows - Implemented comprehensive testing strategies ensuring 95%+ code coverage',
  ...
  },
  {
    ...
    startDate: new Date(),
    // endDate is omitted for current position
    description: '- Architected hybrid AI systems combining GPT/Claude with rule-based validation for 99%+ accuracy in document processing - Developed automated workflows reducing manual document review time by 70% - Implemented robust error handling and fallback mechanisms for mission-critical healthcare data processing',
    technologies: ['AI'],
    achievements: ['Architected hybrid AI systems combining GPT/Claude with rule-based validation for 99%+ accuracy in document processing',

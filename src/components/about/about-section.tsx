...
const marcelExperiences: Experience[] = [
  {
    ...
    description: 'Delivered full stack systems using React, Vue, Next.js, and backend with Node.js. Migrated monoliths to monorepo, implemented SSR, and optimized cloud deployments.',
    technologies: ['React', 'Next.js', 'Node.js', 'Figma', 'AI'],
    achievements: ['Strong UX sensibility using Figma and design systems',
  ...
  },
  {
    ...
    description: 'Founded the agency to provide web and e-commerce solutions to local businesses. Built full stack apps using WordPress, WooCommerce, Shopify, Webflow.',
    technologies: ['WordPress', 'WooCommerce', 'Shopify', 'Webflow'],
    achievements: ['Led projects using Agile, from prototyping and UX to deployment and optimization',
  ...
  },
  {
    ...
    technologies: ['TypeScript', 'JavaScript', 'Java', 'Go', 'PostgreSQL', 'MongoDB', 'AWS', 'Orkes/Conductor', 'Novu', 'EventBridge', 'Lambda', 'AI', 'Automation', 'OpenAI API'],

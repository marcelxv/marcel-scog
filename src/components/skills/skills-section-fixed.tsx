    ...
    <div className="max-w-6xl mx-auto space-y-12">
      {skillCategories.map(category => (
        <div
          ...
          className="bg-white dark:bg-neutral-700 rounded-2xl p-8 shadow-sm"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
            {category.skills.map(skill => (
              <div key={skill.name} className="group">
                <div className="px-4 py-3 bg-neutral-50 dark:bg-neutral-950 rounded-lg hover:bg-accent-100 dark:hover:bg-neutral-700 transition-colors duration-200 cursor-default">
    ...
    >
      {skillCategories.map((category, categoryIndex) => (
        <motion.div
          ...
          className="bg-white dark:bg-neutral-700 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300"
        >
          <h3 className="text-xl font-bold text-text-900 dark:text-white mb-6 pb-3 border-b border-neutral-200 dark:border-neutral-800">
            {category.category}
          </h3>
